...
var GetTaskSystem = function(obj){
    if(!_cache.TaskSystem){
        _cache.TaskSystem = $('<div class="popup-menu task-menu" style="z-index:99999;bottom:30px;display:none"><ul><li><a menu="close" href="https://github.com/tonyxyl" target="_blank">github</a></li><li><a menu="close" href="mailto:xcc2533919@163.com?subject=听歌">联系我</a></li></ul></div>');
